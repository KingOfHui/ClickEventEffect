...
/**
 * @ClassName ClickEventsTextView
 * @Description
 * @Author dinghui
 * @Date 2020/8/17 0017 14:52
 */
public class ClickEventsTextView extends AppCompatTextView {

    private BaseEventsProxy mEffectsProxy;

    public ClickEventsTextView(Context context) {
        this(context,null);
    }

    public ClickEventsTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickEventsTextView(Context context, @Nullable AttributeSet attrs, BaseEventsProxy effectsProxy) {
